...
func TestReachable(t *testing.T) {
	...
	tests := []struct {
		...
		//Modified from piazza, I couldnt think of anymore :(
		{"dagTransitions", 0, 0, []rune{}, true},
		{"dagTransitions", 0, 1, []rune{}, false},
		{"dagTransitions", 0, 0, nil, true},
		{"dagTransitions", 0, 1, nil, false},
		{"dagTransitions", 12345, 12345, []rune{}, true},
		{"dagTransitions", 12345, 12345, nil, true},

		{"expTransitions", 0, 0, []rune{}, true},
		{"expTransitions", 0, 1, []rune{}, false},
		{"expTransitions", 0, 0, nil, true},
		{"expTransitions", 0, 1, nil, false},
		{"expTransitions", 12345, 12345, []rune{}, true},
		{"expTransitions", 12345, 12345, nil, true},

		{"langTransitions", 0, 0, []rune{}, true},
		{"langTransitions", 0, 1, []rune{}, false},
		{"langTransitions", 0, 0, nil, true},
		{"langTransitions", 0, 1, nil, false},
		{"langTransitions", 12345, 12345, []rune{}, true},
		{"langTransitions", 12345, 12345, nil, true},
	}
